...
class Menu:
    def __init__(self, screen):
        self.screen = screen
        self.vscomputer = ui.Button(screen, Config.width//2, Config.height//2, 200, 80, "vs Parsa AI")
        ...
        self.title = ui.TextUI(self.screen, "Parsa AI Bot", Config.width//2, Config.height//8, 140, (255, 255, 255))
